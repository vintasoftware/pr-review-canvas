import { type CanvasTally, tallyMarkdown } from '../review/self-review.js'
 ...
 */
export function buildCanvasComment(zip: CanvasZip, tally: CanvasTally, limit: number): string {
