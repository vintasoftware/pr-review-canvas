...
export function syntheticArtifact(): ReviewArtifact {
  ...
  return {
    ...
    files,
    summary: 'Before, `run()` returned `a()`. After, it adds `b()`, see [app.ts](#chunk:src/app.ts#1).',
    ...
    layers: [
      {
        ...
        decisions: 'Sum over product, see [app.ts](#chunk:src/app.ts#1).',
        ...
        files: [
          ...
          { path: 'src/new-name.ts', chunks: ['src_new_name_ts#1'], isTest: false, annotations: [] },
          { path: 'src/app.test.ts', chunks: ['src_app_test_ts#1'], isTest: true, annotations: [] },
        ],
      },
      {
        id: 'layer-2',
        key: 'other',
        title: 'Other changes',
        rationale: 'Second chunk, new file, deletion.',
        kind: 'other',
        risk: [],
        tests: [],
        files: [
          { path: 'src/app.ts', chunks: ['src_app_ts#2'], isTest: false, annotations: [] },
          { path: 'src/new.ts', chunks: ['src_new_ts#1'], isTest: false, annotations: [] },
          { path: 'src/gone.ts', chunks: ['src_gone_ts#1'], isTest: false, annotations: [] },
        ],
      },
    ],
    points: [
